  ...
  if (version == url + "public/naroom-gb.png") {
    if (nextid == 1 && idioma == "<h2>FAMILY</h2>") {
      ...
      document.getElementById("body-work-Cescobar").innerHTML =
        'Band / Landing Page<br><a href="https://caecescobar.github.io/01_guesthouse" target="_blank" class="text-body-secondary">Link</a>';
      ...
      document.getElementById("header-work-Cescobar").innerHTML = "GUEST HOUSE";
      document.getElementById("body-work-Cescobar").innerHTML =
        'Banda / Landing Page<br><a href="https://caecescobar.github.io/01_guesthouse" target="_blank" class="text-body-secondary">Link</a>';
      document.getElementById("workimg1").src = "public/work-gh-1-gb.png";
      document.getElementById("workimg2").src = "public/work-gh-2-gb.png";
      document.getElementById("workimg3").src = "public/work-gh-5-gb.png";
...
function gb() {
  ...
  document.getElementById("logoangular").src = "public/logo-angular-gb.png";
  document.getElementById("logotypescript").src = "public/logo-typescript-gb.png";
  document.getElementById("logojs").src = "public/logo-javascript-gb.png";
  document.getElementById("logodotnet").src = "public/logo-dotnet-gb.png";
  document.getElementById("logocsharp").src = "public/logo-csharp-gb.png";
  document.getElementById("logosql").src = "public/logo-sql-gb.png";
...
function gbc() {
  ...
  document.getElementById("logoangular").src = "public/logo-angular.png";
  document.getElementById("logotypescript").src = "public/logo-typescript.png";
  document.getElementById("logojs").src = "public/logo-javascript.png";
  document.getElementById("logodotnet").src = "public/logo-dotnet.png";
  document.getElementById("logocsharp").src = "public/logo-csharp.png";
  document.getElementById("logosql").src = "public/logo-sql.png";
...
function eng() {
  ...
  document.getElementById("modal-body-about").innerHTML =
    "<h4>Hi! my name is Carlos</h4><p>and I am an experienced programmer with skills in both Frontend and Backend technologies such as Angular, TypeScript, NET, Laravel, C#, among others. I strive to maintain high standards of code quality and focus on meeting goals and deadlines. Working with me guarantees clear and efficient communication. Don't hesitate to contact me to discuss how I can assist you on your next project!</p>";
  // CONTACT
...
function esp() {
  ...
  document.getElementById("modal-header-about").innerHTML = "<h2>SOBRE MÍ</h2>";
  document.getElementById("modal-body-about").innerHTML =
    "<h4>¡Hola! soy Carlos</h4><p>y soy un programador experimentado con habilidades tanto en Frontend como Backend con tecnologías como Angular, TypeScript, NET, Laravel, C#, entre otras. Me esfuerzo por mantener altos estándares de calidad de código y me enfoco en cumplir metas y plazos. Trabajar conmigo garantiza una comunicación clara y eficiente. ¡No dudes en contactarme para discutir cómo puedo ayudarte en tu próximo proyecto!</p>";
  // CONTACT
  document.getElementById("modal-header-contact").innerHTML =
    "<h2>CONTACTO</h2>";
  document.getElementById("modal-body-contact").innerHTML =
