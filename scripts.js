...
function gb() {
  ...
  document.getElementById("workimg0").src = "public/work-cescobar-1-gb.png";
...
function gbc() {
  ...
  document.getElementById("workimg0").src = "public/work-cescobar-1.jpg";
...
function eng() {
  ...
  document.getElementById("footer-work-Cescobar").innerHTML =
    "C.ESCOBAR ARCHITECT";
  // HOBBIES
  ...
  document.getElementById("modal-body-about").innerHTML =
    "<h4>Hi! my name is Carlos</h4><p>and I am an experienced programmer skilled in React and JavaScript. I strive to maintain high standards of code quality and focus on meeting goals and deadlines. Working with me guarantees clear and efficient communication. Don't hesitate to contact me to discuss how I can assist you on your next project!</p>";
  // CONTACT
...
function esp() {
  ...
  document.getElementById("body-work-Cescobar").innerHTML =
    'Arquitecto / Portafolio<br><a href="https://www.ce-arq.xyz/index.html" target="_blank" class="text-body-secondary">Link</a>';
  document.getElementById("footer-work-Cescobar").innerHTML =
    "C.ESCOBAR ARQUITECTO";
  // HOBBIES
  document.getElementById("modal-body-hobbies").innerHTML =
